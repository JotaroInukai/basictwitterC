...
def basicC_template(request):
    return render(request,"basicC.html")


def basicC_form_show(request):
    return render(request,"basicCresult.html")

def basicC_form_show2(request):
    return render(request,"basicCresult2.html")


def basicC_form_show3(request):
    return render(request,"basicCresult3.html")

def basicC_form_show4(request):
    return render(request,"basicCresult4.html")

def basicC_form(request):
    ...
    return render(request,'basicCresult.html',payload)


def basicC_form2(request):
    sagilistA=sagilist()
    ...
    return render(request,'basicCresult2.html',payload)

def basicC_form4(request):
    sagidict=sagilist()
    hisagidict=hisagilist()
    data=request.POST.get("hidden_data")
    splitdata=(data.split(","))
    ...
    return render(request,'basicCresult4.html',payload)
